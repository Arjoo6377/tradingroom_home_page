        ...
        >
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center px-6 lg:px-10 py-10 lg:py-20 flex-grow">
            <div className="max-w-lg text-center lg:text-left mt-4 lg:mt-0">
              <h1 className="text-2xl lg:text-5xl xl:text-6xl font-extrabold mb-6 leading-tight">
                Your path to trading <br /> Mastery{" "}
                <span className="text-green-400">starts here</span>
              </h1>
              <button className="bg-green-500 text-gray-900 px-4 lg:px-6 py-2 lg:py-3 rounded mt-4 hover:bg-green-600">
                Explore Membership
              </button>
              <div className="flex items-center justify-center lg:justify-start mt-6 relative">
                <img
