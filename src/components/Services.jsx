...
function Services() {
  ...
  useEffect(() => {
    ...
    intervalRef.current = setInterval(handleCarousel, 1000);
  ...
  return (
    <section className="bg-green-100 mt-28" style={{ height: "80vh" }}>
      <div
        className="mx-auto px-4 ism:px-6 lg:px-8 bg-teal-900 rounded-3xl sm:w-full md:w-4/5 lg:w-3/4"
        style={{
          height: "auto",
          minHeight: "600px",
        }}
      >
        ...
        <div className="carousel-container">
          <div
            className="carousel-slide flex transition-transform duration-500 items-center justify-center "
          ...
          >
            ...
            <div
              ...
              className="flex flex-col items-center justify-between w-full sm:w-64 md:w-72 lg:w-80 min-w-0 h-[350px] p-4  bg-teal-800 rounded-lg shadow-md border-gray-300"
            >
